/**
 * UCU Institutional Rankings Data Store
 * Schema: org, year, mainRankLabel, mainRank, category, badgeClass, crownBadgeClass, shortDescription, publicationUrl, publicationDate, metrics[{}]
 */
window.UCU_RANKINGS = [
  {
    org: "AppliedHE",
    ...
    mainRank: "241-260",
    category: "All Asia",
    badgeClass: "bg-ucu-yellow text-main2",
    crownBadgeClass: "bg-ucu-yellow text-main2",
  ...
  },
  {
    ...
    badgeClass: "bg-ucu-blue text-white",
    crownBadgeClass: "border border-ucu-blue text-ucu-blue bg-white",
  ...
  },
  {
    ...
    crownBadgeClass: "border border-[#00993d] text-[#00993d] bg-white",
  ...
  },
  {
    ...
    badgeClass: "bg-ucu-red text-white",
    crownBadgeClass: "border border-ucu-red text-ucu-red bg-white",
  ...
  },
  {
    ...
    metrics: [
      { label: "Locale Univ. in the PH", value: "#1", subtext: "", color: "#00993d" },
      { label: "Province of Pangasinan", value: "#1", subtext: "", color: "#00993d" },
      { label: "Region 1", value: "#3", subtext: "", color: "#00993d" },
      { label: "Philippines", value: "#8", subtext: "", color: "#00993d" },
      { label: "Asia", value: "#189", subtext: "", color: "#00993d" }
    ]
  }
];